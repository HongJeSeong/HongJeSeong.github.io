...
---
# Software Visualzation Ubuntu
`2019-01-22 우분투 환경 구축 기록`
`OS : Ubutu 18.04`

# - 방법 1. 각각의 설치 과정
# - 방법 2. shell script를 통한 설치 후 설정파일 수정
...
```
기존의 `JKWokersFile /etc/libapache2-mod-jk/workers.properties`를 #주석처리 후,
