...
- <font style="color:#ed7d31"><strong>주황색</strong></font>은 윈도우로, 반복문에서  i번째와 i+1번째, 두 원소를 비교한다.
- <font style="color:#5d9cd5"><strong>파란색</strong></font>은 원소 비교시, 연속적으로 오름차순이면 그 배열은 한 묶음이 된다.  
- <font style="color:##ff0000"><strong>빨간색</strong></font>은  원소 비교시 오름차순이 아닌 것을 의미한다.
